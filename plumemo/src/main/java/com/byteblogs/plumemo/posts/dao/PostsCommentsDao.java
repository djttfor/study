...
public interface PostsCommentsDao extends BaseDao<PostsComments> {
    ...
    List<MyPostsComments> selectMyPostsCommentsList(Page<MyPostsComments> page, @Param("postsId") Long postsId, @Param("parentId") Long parentId);

    List<MyPostsComments> selectReplyMyPostsCommentsList(Page<MyPostsComments> objectPage,@Param("postsId") Long postsId, @Param("parentId") Long parentId);

    Integer saveReplyComments(MyPostsComments myPostsComments);
}
