...
public interface PostsCommentsService extends BaseService<PostsComments> {
    ...
    Result<MyPostsComments> getCommentsList(Integer current, Integer pageSize,
                                            Long postsId, Long parentId);

    Result saveMyPostsComments(MyPostsComments myPostsComments);

    Result<MyPostsComments> getReplyList(Long postsId, Long parentId,Integer replyCount);
}
