	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/permission/all">权限管理</a></li>
			...
			<div class="box box-primary">
						...
						<div class="panel panel-default">
							...
							<div class="row data-type">
								...
								<div class="col-md-4 data">
									<input type="text" class="form-control"
										   value="${permission.permissionName}" readonly="readonly">
								</div>
								<div class="col-md-2 title">权限路径</div>
								<div class="col-md-4 data">
									<input type="text" class="form-control"
										   value="${permission.url}" readonly="readonly">
								</div>
								<div class="col-md-2 title">权限描述</div>
							</div>
							<div class="panel-heading">拥有此权限的角色</div>
							<table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
								<c:forEach items="${permission.roles}" var="r" >
									<tr>
										<td>${r.roleName}</td>
										<td>${r.roleDesc}</td>
									</tr>
