...
<div class="wrapper">
    ...
    <div class="content-wrapper">
       ...
       <%--此处提交表单--%>
        <form autocomplete="off" method="post" action="${pageContext.request.contextPath}/product/addProduct">
        ...
        <div class="row data-type">
            ...
            <div class="col-md-4 data text">
                <input type="text" class="form-control" name="productNumber"
                       placeholder="产品编号" value="${product.pid}" readonly = "readonly">
            </div>
            ...
            <div class="col-md-4 data text">
                <input type="text" class="form-control" name="productName"
                       placeholder="路线名称" value="${product.productName}"  readonly = "readonly">
            </div>
            ...
            <div class="col-md-4 data">
                <select class="form-control select2" style="width: 100%"
                    ...
                    <option value="${product.productStatus}" selected="selected">${product.productStatus==1 ?'开启':'关闭'}</option>
                </select>
            </div>
